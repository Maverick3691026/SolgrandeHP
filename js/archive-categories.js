(function () {
  ...
  var categories = {
    ...
    magic: {
      ...
      entries: [
        ["元素術", "火、水、風、土など自然現象へ干渉する術式。"],
        ["星辰術", "星の巡り、暦、予兆を読む高等魔法。"],
    ...
    glossary: {
      ...
      entries: [
        ...
        ["星冠暦", "王国圏で広く使われる暦。王権と星辰信仰に由来する。"],
        ["古誓約", "神話時代に交わされたとされる、人と魔力の関係を定めた契約。"],
        ["王都文書院", "国家記録、系譜、魔術研究資料を保管する公式機関。"]
      ]
    }
  };
